    ...
    def handle(self, *args, **options):
        ...
        banners_data = [
            ...
            },
            {
                ...
                'description': 'Бесплатная доставка при заказе от 5000сум',
                'color': (100, 255, 150),
        ...
        faqs_data = [
            ...
            },
            {
                ...
                'answer': 'При заказе от 5000сум доставка бесплатная. Для заказов на меньшую сумму стоимость доставки составляет от 300сум в зависимости от региона и веса товара.',
                'order': 1
            },
            {
                'category': 'Доставка',
